...
public class MemberService implements UserDetailsService {
	...
	public Token login(String loginID, String password, boolean isPC) {
		...
		try {
			...
			if (isPC) {
//            stringStringValueOperations.set("PC"+authentication.getName(), token.getRefreshToken(), token.getRefreshToken().expirationAt().toEpochMilli() - now, TimeUnit.MILLISECONDS);
			} else {
