...
public class MemberController {
  ...
  @GetMapping
  @ResponseBody
  public ResponseEntity<?> getMemberInfo(@Auth String loginId) {
  ...
  public ResponseEntity<?> deleteMember(@Auth String loginId) {
    log.info(" loginId = {}", loginId);
  ...
  public ResponseEntity<?> upload(
    ...
    @Auth String loginId) throws IOException {
  ...
  @PutMapping("/change")
  @ResponseBody
  public ResponseEntity<?> changeToMember(@Auth String loginId,
