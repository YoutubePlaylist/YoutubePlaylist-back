...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 2; //test용 2분  * 30 // 30분
    private static final long REFRESH_TOKEN_EXPIRE_TIME_APP = 1000L * 60 * 5;  //test용 5분  * 60 * 24 * 7; // 7일
    private static final long REFRESH_TOKEN_EXPIRE_TIME_PC = 1000L * 60 *5; // test용 5분 //* 60 * 24 * 7 * 4 * 3;  // 3개월
