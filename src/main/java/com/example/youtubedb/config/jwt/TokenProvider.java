...
public class TokenProvider {
    ...
    private static final long REFRESH_TOKEN_EXPIRE_TIME_PC = 1000L * 60 * 60 * 24 * 7;  // 7일
    private static final long REFRESH_TOKEN_EXPIRE_TIME_APP = 1000L * 60 * 60 * 24 * 7 * 4 * 3;  // 3개월
