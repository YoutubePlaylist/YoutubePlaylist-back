...
class MemberServiceIntegrationTest {
  ...
  void 로그인() {
    ...
    // when
    Member member = memberService.registerReal(loginId, password, false);
    MemberForTokenDto memberForTokenDto = new MemberForTokenDto(member.isPC(), member.getLoginId());
  ...
  void 로그인_비밀번호_불일치() {
    ...
    // when & then
    assertThrows(DoNotMatchPasswordException.class, () -> memberService.login(memberForTokenDto, otherPassword));
  }
